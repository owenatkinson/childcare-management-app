...
const StackNavigator = () => {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        name="LogMedicine"
        component={LogMedicine}
        options={{ title: "Log Medicical Info" }}
      />
      <Stack.Screen
        name="UpdateMedicineLog"
        component={UpdateMedicineLog}
        options={{ title: "Update Medicine Info" }}
      />
      <Stack.Screen
        name="ViewMedicalInfo"
        component={ViewMedicalInfo}
        options={{ title: "View Medicine Info" }}
      />
      <Stack.Screen name="Planner" component={Planner} options={{ title: "Planner" }} />
      <Stack.Screen
        name="HealthSafetyChecks"
        component={HealthSafetyChecks}
        options={{ title: "Health & Safety Checks" }}
      />
      <Stack.Screen
        name="DailyCovidAssessment"
        component={DailyCovidAssessment}
        options={{ title: "COVID Assessment" }}
      />
      <Stack.Screen
        name="AddDailyCovidAssessment"
        component={AddDailyCovidAssessment}
        options={{ title: "COVID Assessment" }}
      />
      <Stack.Screen
        name="AddDailyRiskAssessment"
        component={AddDailyRiskAssessment}
        options={{ title: "Risk Assessment" }}
      />
      <Stack.Screen
        name="AddMonthlyDrillList"
        component={AddMonthlyDrillList}
        options={{ title: "Fire Drill" }}
      />
      <Stack.Screen
        name="AddMonthlyFireSafetyEquipmentList"
        component={AddMonthlyFireSafetyEquipmentList}
        options={{ title: "Fire Safety Equipment Check" }}
      />
      <Stack.Screen
        name="DailyRiskAssessment"
        component={DailyRiskAssessment}
        options={{ title: "Risk Assessment" }}
      />
      <Stack.Screen
        name="MonthlyFireDrill"
        component={MonthlyFireDrill}
        options={{ title: "Fire Drill" }}
      />
      <Stack.Screen
        name="MonthlyFireSafetyEquipmentCheck"
        component={MonthlyFireSafetyEquipmentCheck}
        options={{ title: "Fire Safety Equipment Check" }}
      />
      <Stack.Screen
      ...
      <Stack.Screen
        ...
        options={{ title: "View Active Children" }}
      />
      <Stack.Screen
        name="ViewInactiveChildren"
        component={ViewInactiveChildren}
        options={{ title: "View Inactive Children" }}
      />
      <Stack.Screen
        name="UpdateChildDetails"
        component={UpdateChildDetails}
        options={{ title: "Update Child Details" }}
      />
      <Stack.Screen
        name="AccidentReports"
        component={AccidentReports}
        options={{ title: "Accident Reports" }}
      />
      <Stack.Screen
        name="LogAccidentReport"
        component={LogAccidentReport}
        options={{ title: "Log Accident Reports" }}
      />
      <Stack.Screen
        name="ViewAccidentReports"
        component={ViewAccidentReports}
        options={{ title: "View Accident Reports" }}
      />
      <Stack.Screen
        name="UpdateAccidentReport"
        component={UpdateAccidentReport}
        options={{ title: "Update Accident Report" }}
      />
      <Stack.Screen name="Finances" component={Finances} options={{ title: "Finances" }} />
      <Stack.Screen
        name="UpdateVisitorLog"
        component={UpdateVisitorLog}
        options={{ title: "Update Visitor Log" }}
      />
      <Stack.Screen name="LogVisitor" component={LogVisitor} options={{ title: "Log Visitor" }} />
      <Stack.Screen
        name="ViewVisitorLogs"
      ...
      <Stack.Screen
        ...
        options={{ title: "View Invoice" }}
      />
      <Stack.Screen
        name="UpdateInvoice"
        component={UpdateInvoice}
        options={{ title: "Update Invoice" }}
      />
      <Stack.Screen name="LogMiles" component={LogMiles} options={{ title: "Log Mileage" }} />
      <Stack.Screen
        name="ViewMiles"
        component={ViewMiles}
        options={{ title: "View Mileage Logs" }}
      />
      <Stack.Screen
        name="UpdateMiles"
        component={UpdateMiles}
        options={{ title: "Update Mileage Log" }}
      />
      <Stack.Screen
        name="ProductScreen"
